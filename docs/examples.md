...
- Filter: IC50 < 100 nM, pChEMBL value > 7  # relaxed from 50 nM to capture more scaffolds
...
# coverage and runtime (~2 min on my machine). Going above 1000 starts to slow
# things down noticeably without adding many unique scaffolds. -- personal note
```
